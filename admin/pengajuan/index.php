            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pengajuan Siswa Izin/Sakit</h1>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              DATA PENGAJUAN SELURUH SISWA IZIN/SAKIT
            </div>
            <div class="card-body">
              <a href="tambah-pengajuan.php" class="btn btn-md btn-success" style="margin-bottom: 15px"><i class="fa-solid fa-user-plus mr-4"></i> TAMBAH PENGAJUAN </a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="detai-pengajuan.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-danger"><i class="fa-solid fa-eye"></i></a>
                        <a href="edit-pengajuan.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="hapus-pengajuan.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-danger"><i class="fa-solid fa-circle-xmark"></i></a>
                        <a href="setuju.php?id=<?php echo $row['id_siswa'] ?>" class="btn btn-sm btn-primary"><i class="fa-solid fa-circle-checkmark"></i></a>    
                    </td>
                  </tr>
