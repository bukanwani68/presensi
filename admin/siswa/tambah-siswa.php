          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="simpan-siswa.php" method="POST">
                ...
                <div class="form-group">
                  <label>Kelas</label>
                  <textarea class="form-control" name="kelas" placeholder="Masukkan Kelas Siswa" rows="4"></textarea>
                </div>

                <div class="form-group">
                  <label>Jurusan</label>
                  <textarea class="form-control" name="jurusan" placeholder="Masukkan Jurusan Siswa" rows="4"></textarea>
                </div>
