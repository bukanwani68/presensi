            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Nama Siswa Sakit</h1>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              DATA SELURUH SISWA SAKIT
            </div>
            <div class="card-body">
              <a href="tambah-sakit.php" class="btn btn-md btn-success" style="margin-bottom: 15px"><i class="fa-solid fa-user-plus mr-4"></i>  TAMBAH DATA SISWA SAKIT </a>
              <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                  <?php 
                      include('../../koneksi.php');
                      $no = 1;
                      $query = mysqli_query($connection,"SELECT * FROM tbl_sakit");
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="sakit.php?id=<?php echo $row['id_sakit'] ?>" class="btn btn-sm btn-success">DETAIL <i class="fa-solid fa-circle-check"></i></a>
                        <a href="edit-sakit.php?id=<?php echo $row['id_sakit'] ?>" class="btn btn-sm btn-primary">EDIT <i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="hapus-sakit.php?id=<?php echo $row['id_sakit'] ?>" class="btn btn-sm btn-danger">HAPUS <i class="fa-solid fa-circle-xmark"></i></a>
                        </td>
                  </tr>
